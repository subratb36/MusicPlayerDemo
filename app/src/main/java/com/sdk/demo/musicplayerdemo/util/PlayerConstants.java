...
public class PlayerConstants {
	...
	public static String STARTFOREGROUND_ACTION = "com.sdk.demo.musicplayerdemo.util.action.startforeground";
	public static String STOPFOREGROUND_ACTION = "com.sdk.demo.musicplayerdemo.util.action.stopforeground";
